...
#     # if not user_data:  # Check if user_data is an empty list
#     #     res=kpis.append("No data available for this machine.")
#     #     print('res',res)
...
#
#         # print('channel layer', async_to_sync(channel_layer.group_send)(machine_id, {"type": "kpiweb", "text": res}))
#
